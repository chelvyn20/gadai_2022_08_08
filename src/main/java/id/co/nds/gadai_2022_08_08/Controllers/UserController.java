...
public class UserController {
    ...
    public ResponseEntity<ResponseModel> putProductController(@Validated(UpdatingById.class) @RequestBody UserModel userModel){
        try{
    ...
    public ResponseEntity<ResponseModel> deleteProductController(@Validated(deletingById.class) @RequestBody UserModel userModel){
        try{
