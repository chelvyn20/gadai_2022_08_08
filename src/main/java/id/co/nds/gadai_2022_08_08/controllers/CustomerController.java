...
public class CustomerController {
    ...
    public ResponseEntity<ResponseModel> doSearchPelanggan(@Validated(GettingAllByCriteria.class) @RequestBody CustomerModel customerModel) {
    ...
    public ResponseEntity<ResponseModel> doGetDetailPelanggan(@Validated(GettingById.class) @RequestBody CustomerModel customerModel) {
    ...
    public ResponseEntity<ResponseModel> doUpdatePelanggan(@Validated(UpdatingById.class) @RequestBody CustomerModel customerModel) throws NoSuchElementException, ClientException {
    ...
    public ResponseEntity<ResponseModel> doDeletePelanggan(@Validated(DeletingById.class) @RequestBody CustomerModel customerModel) throws NoSuchElementException, ClientException {
